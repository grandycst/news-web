  ...
  <div class="row">
    ...
    ?>
        <tr>
            ...
            <td><img src="uploads/<?php echo $data['foto_tim']; ?>" alt="Foto Tim" class="img-thumbnail" style="max-width: 100px;"></td>
            <td>
            <div class="d-flex justify-content-center ">
                                        <a href="?page=tim/ubah&id_tim=<?= $data['id_tim'] ?>"
                                            class="btn btn-success mr-3"><i class="fa fa-pencil-alt"></i> Ubah</a>
                            
            <a href="tim/hapus.php?id_tim=<?=$data['id_tim'];?>" class="btn btn-danger " onclick="return confirm('yakin?')";><i class="fas fa-trash"></i>Hapus</a>
            </td>
        </tr>
            </tbody>
            <?php } ?>
