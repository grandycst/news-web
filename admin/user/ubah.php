...
//include "../koneksi.php";
//$user= $_GET['id_user'];
$ubah = mysqli_query($koneksi, "SELECT * FROM user WHERE id_user='$user'");
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_lengkap" id="nama_lengkap" class="form-control"
                                    placeholder="nama_lengkap" value="<?= $data['nama_lengkap']; ?>" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php if ($data['foto']): ?>
                                <img src="user/foto/<?= $data['foto']?>" alt="Foto Lama" class="img-fluid mt-2"
