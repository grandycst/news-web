...
.my-float{
                        ...
                        <div class="top-info flex-grow-0">
                            ...
                            <div class="overflow-hidden" style="width: 735px;">
                                <div id="note" class="ps-2">
                                    <img src="assest/img/features-fashion.jpg" class="img-fluid rounded-circle border border-3 border-primary me-2" style="width: 30px; height: 30px;" alt="">
    ...
    <div class="dropdown-menu m-0 bg-secondary rounded-0">
        <?php 
            ...
            while ($row_kat = mysqli_fetch_array($kategori)) {
        ?>
            <a href="index.php?nama_kategori=<?php echo $row_kat['nama_kategori']; ?>" class="dropdown-item">
        ...
        ?>
                            ...
                            <div class="d-flex flex-nowrap border-top pt-3 pt-xl-0">
                                <div class="d-flex">
                                    <img src="assest/img/weather-icon.png" class="img-fluid w-100 me-2" alt="">
    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content rounded-0">
            ...
            <div class="modal-body d-flex align-items-center">
                <form method="POST" action="" class="input-group w-75 mx-auto d-flex">
